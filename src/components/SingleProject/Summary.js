        ...
        <div class="row">
          ...
          <div class="col-md-6 pl-5">
            <div class="singl-project-sec2-cont">
              <h6>Breif</h6>
              <p>
                This brief lent itself perfectly to a multichannel campaign, all
                highly targeted and personalised to the most relevant audiences.
                <br />
                <br />
                The capital modelling webinar series had some great insights and
                expertise for the reinsurance industry, from CFOs to actuaries -
                therefore, the messaging for each audience had to be relevant
                and engaging, addressing their specific needs and challenges
                around risk and capital modelling. At the same time, it was
                incredibly important for our messaging to be
